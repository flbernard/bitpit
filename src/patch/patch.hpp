...
public:
	...
	long countIsolatedVertices();
	std::vector<long> findIsolatedVertices();
...
protected:
	...
	void setAdvancedEditable(bool locked);

private:
	bool m_dirty;
	bool m_advancedEditable;
